...
rp_module_desc="C64 emulator VICE - extra for SCPU and Joyport Swakking"
...
function configure_viceextra() {
    ...
    addEmulator 0 "vice-x64-joy2" "c64" "/opt/retropie/emulators/vice/bin/vice.sh x64 %ROM% -config /opt/retropie/configs/c64/sdl-vicerc-swapjoy"
    addEmulator 0 "vice-x128-joy2" "c64" "/opt/retropie/emulators/vice/bin/vice.sh x128 %ROM% -config /opt/retropie/configs/c64/sdl-vicerc-swapjoy"
}
